function verif() {
  ...
  function verif1() {
    ...
    if (0 <= x && x <= 20) {
      ...
      c3.style.cssText = "border-color:red";
    }
    if (0 <= y && y <= 20) {
  ...
  function verif9124() {
    let x = document.getElementById("ch18").value;
    let y = document.getElementById("ch19").value;
    let z = document.getElementById("sh10").value;
    let f = String((Number(x) + Number(y) + Number(z) * 2) / 4);
    let sp = document.getElementById("sph");
    let m = document.getElementById("m");
    document.getElementById("sph10").value = parseFloat(f).toFixed(2);
    if (0 <= x && x <= 20) {
      ch18.style.cssText = "background:white";
    } else {
      ch18.style.cssText = "background:red";
    }
    if (0 <= y && y <= 20) {
      ch19.style.cssText = "background:white";
    } else {
      ch19.style.cssText = "background:red";
    }
    if (0 <= z && z <= 20) {
      sh10.style.cssText = "background:white";
    } else {
      sh10.style.cssText = "background:red";
    }
  }
  document.getElementById("ch18").addEventListener("input", verif9124);
  document.getElementById("ch19").addEventListener("input", verif9124);
  document.getElementById("sh10").addEventListener("input", verif9124);
  function verif912422() {
    let x = document.getElementById("chh18").value;
    let y = document.getElementById("chh19").value;
    let z = document.getElementById("shh10").value;
    let f = String((Number(x) + Number(y) + Number(z) * 2) / 4);
    let sp = document.getElementById("sphh");
    let m = document.getElementById("m");
    document.getElementById("sphh10").value = parseFloat(f).toFixed(2);
    if (0 <= x && x <= 20) {
      chh18.style.cssText = "background:white";
    } else {
      chh18.style.cssText = "background:red";
    }
    if (0 <= y && y <= 20) {
      chh19.style.cssText = "background:white";
    } else {
      chh19.style.cssText = "background:red";
    }
    if (0 <= z && z <= 20) {
      shh10.style.cssText = "background:white";
    } else {
      shh10.style.cssText = "background:red";
    }
  }
  
  document.getElementById("chh18").addEventListener("input", verif912422);
  document.getElementById("chh19").addEventListener("input", verif912422);
  document.getElementById("shh10").addEventListener("input", verif912422);
  function test() {
    ...
    let ml = document.getElementById("sph10").value;
    let mli = document.getElementById("sphh10").value;
    let x =
      (Number(a) +
        Number(b) +
        Number(c) +
