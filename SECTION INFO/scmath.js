...
function verif100(){
    let x = document.getElementById("c997").value;
    let y = document.getElementById("c998").value;
    let z = document.getElementById("s999").value;
    let f = String((Number(x) + Number(y) + (Number(z) * 2)) / 4);
    let sp = document.getElementById("sp");
    let m = document.getElementById("m");
    document.getElementById("sp999").value=parseFloat(f).toFixed(2);;
    if (0 <= x && x <= 20) {
        c997.style.cssText="background:white"
    } else {
        c997.style.cssText="background:red"
    }
    if (0 <= y && y <= 20) {
        c998.style.cssText="background:white"
    } else {
        c998.style.cssText="background:red"
    }
    if (0 <= z && z <= 20) {
        s999.style.cssText="background:white"
    } else {
        s999.style.cssText="background:red"
    }
}

document.getElementById("c997").addEventListener("input", verif100);
document.getElementById("c998").addEventListener("input", verif100);
document.getElementById("s999").addEventListener("input", verif100);
...
function test(){
    ...
    let bb=document.getElementById("sp999").value
    let x=(Number(a)*2+Number(b)*2+Number(c)*2+Number(d)*4+Number(e)*4+Number(f)+
    Number(g)+Number(h)+Number(i)+Number(j)+Number(bb)+
    Number(k)+Number(l))/22
