...
function verif766(){
    let x = document.getElementById("l1").value;
    let y = document.getElementById("l2").value;
    let z = document.getElementById("l3").value;
    let f = String((Number(x) + Number(y) + (Number(z) * 2)) / 4);
    let sp = document.getElementById("sp");
    let m = document.getElementById("m");
    document.getElementById("l4").value=parseFloat(f).toFixed(2);;
    if (0 <= x && x <= 20) {
        l1.style.cssText="background:white"
    } else {
        l1.style.cssText="background:red"
    }
    if (0 <= y && y <= 20) {
        l2.style.cssText="background:white"
    } else {
        l2.style.cssText="background:red"
    }
    if (0 <= z && z <= 20) {
        l3.style.cssText="background:white"
    } else {
        l3.style.cssText="background:red"
    }
}
document.getElementById("l1").addEventListener("input", verif766);
document.getElementById("l2").addEventListener("input", verif766);
document.getElementById("l3").addEventListener("input", verif766);
function verif7(){
...
function verif76(){
    let x = document.getElementById("j1").value;
    let y = document.getElementById("j2").value;
    let z = document.getElementById("j3").value;
    let f = String((Number(x) + Number(y) + (Number(z) * 2)) / 4);
    let sp = document.getElementById("sp");
    let m = document.getElementById("m");
    document.getElementById("j4").value=parseFloat(f).toFixed(2);;
    if (0 <= x && x <= 20) {
        j1.style.cssText="background:white"
    } else {
        j1.style.cssText="background:red"
    }
    if (0 <= y && y <= 20) {
        j2.style.cssText="background:white"
    } else {
        j2.style.cssText="background:red"
    }
    if (0 <= z && z <= 20) {
        j3.style.cssText="background:white"
    } else {
        j3.style.cssText="background:red"
    }
}

document.getElementById("j1").addEventListener("input", verif76);
document.getElementById("j2").addEventListener("input", verif76);
document.getElementById("j3").addEventListener("input", verif76);
function verif8(){
...
function test(){
    ...
    let mg=document.getElementById("l4").value
    let h=document.getElementById("sp8").value
    let hl=document.getElementById("j4").value
    let i=document.getElementById("sp9").value
    let j=document.getElementById("sp10").value
    let x=(Number(a)*3+Number(b)*2.5+Number(c)*2.5+Number(d)*1.5+Number(e)*1.5+Number(f)+
    Number(g)+Number(mm)*3+Number(mg)*2.5+Number(h)*1.5+Number(hl)+Number(i)*1.5+Number(j))/22.50
