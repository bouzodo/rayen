...
function verif4(){
    let x = document.getElementById("x9").value;
    let z = document.getElementById("x5").value;
    let f = String((Number(x)+ (Number(z) * 2)) / 3);
    document.getElementById("xsp5").value=parseFloat(f).toFixed(2);
    if (0 <= x && x <= 20) {
...
document.getElementById("x9").addEventListener("input", verif4);
document.getElementById("x5").addEventListener("input", verif4);
...
function test(){
    ...
    let e=document.getElementById("xsp5").value
    ...
    console.log((Number(a)*4+Number(b)*3+Number(c)*3+Number(d)*1.5+Number(e)*1.5+Number(f)+
    Number(g)+Number(mm)+Number(h)+Number(i)+Number(j)))
    let x=(Number(a)*4+Number(b)*3+Number(c)*3+Number(d)*1.5+Number(e)*1.5+Number(f)+
    Number(g)+Number(mm)+Number(h)+Number(i)+Number(j))/19
