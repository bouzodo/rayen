function verif(){
    ...
    if (0 <= x && x <= 20) {
        ...
        document.getElementById("jjj").checked=true
    } else {
        c1.style.cssText="background:red"
        document.getElementById("jjj").checked=false
    }
    if (0 <= y && y <= 20) {
...
function verif555(){
    ...
    let x = document.getElementById("c1200").value;
    let y = document.getElementById("c1300").value;
    let z = document.getElementById("s400").value;
    let f = String((Number(x) + Number(y) + (Number(z) * 2)) / 4);
    let sp = document.getElementById("sp");
    let m = document.getElementById("m");
    document.getElementById("sp400").value=parseFloat(f).toFixed(2);
    if (0 <= x && x <= 20) {
        c1200.style.cssText="background:white"
    } else {
        c1200.style.cssText="background:red"
    }
    if (0 <= y && y <= 20) {
        c1300.style.cssText="background:white"
    } else {
        c1300.style.cssText="background:red"
    }
    if (0 <= z && z <= 20) {
        s400.style.cssText="background:white"
    } else {
        s400.style.cssText="background:red"
    }
}

document.getElementById("c1200").addEventListener("input", verif555);
document.getElementById("c1300").addEventListener("input", verif555);
document.getElementById("s400").addEventListener("input", verif555);
function verif6(){
...
function test(){
    ...
    let ee=document.getElementById("sp400").value
    ...
    let x=(Number(a)*2+Number(b)*2+Number(c)*2+Number(d)*4+Number(e)*3+Number(f)+
    Number(g)*4+Number(h)+Number(i)+Number(j)+Number(ee)+
    Number(k)+Number(l))/24
