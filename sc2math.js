function verif() {
  ...
  function verif100() {
    let x = document.getElementById("c97").value;
    let y = document.getElementById("c98").value;
    let z = document.getElementById("s99").value;
    let f = String((Number(x) + Number(y) + Number(z) * 2) / 4);
    let sp = document.getElementById("sp");
    let m = document.getElementById("m");
    document.getElementById("sp99").value = parseFloat(f).toFixed(2);
    if (0 <= x && x <= 20) {
      c97.style.cssText = "background:white";
    } else {
      c97.style.cssText = "background:red";
    }
    if (0 <= y && y <= 20) {
      c98.style.cssText = "background:white";
    } else {
      c98.style.cssText = "background:red";
    }
    if (0 <= z && z <= 20) {
      s99.style.cssText = "background:white";
    } else {
      s99.style.cssText = "background:red";
    }
  }
  
  document.getElementById("c97").addEventListener("input", verif100);
  document.getElementById("c98").addEventListener("input", verif100);
  document.getElementById("s99").addEventListener("input", verif100);
  function verif6() {
