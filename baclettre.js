function verif(){
    ...
    let f=String(Number(y)+(Number(z)*2))/3
...
function verif3(){
    ...
    if (0 <= z && z <= 20) {
        s9.style.cssText="background:white"
    } else {
        s9.style.cssText="background:red"
    }
}

document.getElementById("c7").addEventListener("input", verif3);
document.getElementById("c8").addEventListener("input", verif3);
document.getElementById("s9").addEventListener("input", verif3);
function verif4(){
    ...
    if (0 <= z && z <= 20) {
        ...
        s5.style.cssText="background:red"
    }
}
...
document.getElementById("s99").addEventListener("input", verif8);
function verif9(){
...
function test(){
    ...
    Number(mm)*4+Number(h)+Number(i)+Number(j))/21
